...
def densenet201_keras_model(img_rows=224, img_cols=224, channels=3, num_classes=1000, freeze=False, dropout_keep_prob=0.2, use_mvc=False, input_tensor=None, in_model=True):
    ...
    if use_mvc:
            ...
            print("Loading:", "./mvc_checkpoints/densenet201_mvc.hdf5")
            model.load_weights("./mvc_checkpoints/densenet201_mvc.hdf5")
