...
def resnet50_model(img_rows, img_cols, color_type=1, num_classes=None):
    ...
    if K.image_dim_ordering() == 'th':
      ...
      weights_path = 'imagenet_checkpoints/resnet50_weights_th_dim_ordering_th_kernels.h5'
    else:
      # Use pre-trained weights for Tensorflow backend
      weights_path = 'imagenet_checkpoints/resnet50_weights_tf_dim_ordering_tf_kernels.h5'
    ...
    model = Model(img_input, x_newfc, name='resnet_50')
