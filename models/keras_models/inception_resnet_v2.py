...
def inception_resnet_v2_model(img_rows=299, img_cols=299, channels=3, num_classes=1000, freeze=False, dropout_keep_prob=0.2, use_mvc=False, input_tensor=None, in_model=True):
